...
CAM_S::CAM_S(std::shared_ptr<Module> cam) : Module::Interface(std::move(cam), "cam:s", 1) {
    static const FunctionInfo functions[] = {
        ...
        {0x0019, &CAM_S::SetAutoExposure, "SetAutoExposure"},
        {0x001A, &CAM_S::IsAutoExposure, "IsAutoExposure"},
        {0x001B, &CAM_S::SetAutoWhiteBalance, "SetAutoWhiteBalance"},
        {0x001C, &CAM_S::IsAutoWhiteBalance, "IsAutoWhiteBalance"},
        ...
        {0x0026, &CAM_S::SetAutoExposureWindow, "SetAutoExposureWindow"},
        {0x0027, &CAM_S::SetAutoWhiteBalanceWindow, "SetAutoWhiteBalanceWindow"},
        {0x0028, &CAM_S::SetNoiseFilter, "SetNoiseFilter"},
