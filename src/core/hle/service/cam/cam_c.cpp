...
CAM_C::CAM_C(std::shared_ptr<Module> cam) : Module::Interface(std::move(cam), "cam:c", 1) {
    static const FunctionInfo functions[] = {
        ...
        {0x0019, &CAM_C::SetAutoExposure, "SetAutoExposure"},
        {0x001A, &CAM_C::IsAutoExposure, "IsAutoExposure"},
        {0x001B, &CAM_C::SetAutoWhiteBalance, "SetAutoWhiteBalance"},
        {0x001C, &CAM_C::IsAutoWhiteBalance, "IsAutoWhiteBalance"},
        ...
        {0x0026, &CAM_C::SetAutoExposureWindow, "SetAutoExposureWindow"},
        {0x0027, &CAM_C::SetAutoWhiteBalanceWindow, "SetAutoWhiteBalanceWindow"},
        {0x0028, &CAM_C::SetNoiseFilter, "SetNoiseFilter"},
