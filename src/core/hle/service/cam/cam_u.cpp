...
CAM_U::CAM_U(std::shared_ptr<Module> cam) : Module::Interface(std::move(cam), "cam:u", 1) {
    static const FunctionInfo functions[] = {
        ...
        {0x0019, &CAM_U::SetAutoExposure, "SetAutoExposure"},
        {0x001A, &CAM_U::IsAutoExposure, "IsAutoExposure"},
        {0x001B, &CAM_U::SetAutoWhiteBalance, "SetAutoWhiteBalance"},
        {0x001C, &CAM_U::IsAutoWhiteBalance, "IsAutoWhiteBalance"},
        ...
        {0x0026, &CAM_U::SetAutoExposureWindow, "SetAutoExposureWindow"},
        {0x0027, &CAM_U::SetAutoWhiteBalanceWindow, "SetAutoWhiteBalanceWindow"},
        {0x0028, &CAM_U::SetNoiseFilter, "SetNoiseFilter"},
